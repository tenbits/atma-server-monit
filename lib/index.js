...
var Watcher = /** @class */ (function () {
    ...
    Watcher.prototype.watch = function () {
        ...
        this.events.on('HandlerError', function (event, req, res) {
            ...
            if (((_e = _this.opts) === null || _e === void 0 ? void 0 : _e.filterForSlack(event)) === false) {
                return;
            }
            (_f = _this.slack) === null || _f === void 0 ? void 0 : _f.send((_h = (_g = event.error) === null || _g === void 0 ? void 0 : _g.stack) !== null && _h !== void 0 ? _h : event.message);
        });
