...
class LoggerFile {
    ...
    static create(key, opts) {
        ...
        logger.opts = Object.assign(Object.assign({}, opts), { directory: atma_utils_1.class_Uri.combine(opts.directory, key, '/') });
        return logger;
    }
    static prepair(opts) {
        let logger = new LoggerFile();
...
class MonitWorker {
    ...
    createChannel(name, opts = {}) {
        ...
        return this.loggers[name] = LoggerFile_1.LoggerFile.create(name, Object.assign({ directory: this.opts.directory }, opts));
    }
    watch(events) {
