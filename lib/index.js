...
(function () {
	...
	"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function date_getMidnight(date, diffDays) {
...
var LoggerFile = /** @class */ (function () {
    ...
    LoggerFile.prototype.init = function (opts) {
        ...
        if (lastPath != null) {
            var timestamp = Number(rgx.exec(filename)[1]);
...
(function (Monit) {
    ...
    function error(error) {
        watcher === null || watcher === void 0 ? void 0 : watcher.writeError(error);
    }
    Monit.error = error;
...
var Watcher = /** @class */ (function () {
    ...
    Watcher.prototype.watch = function () {
        ...
        this.events.on('HandlerError', function (event, req, res) {
            ...
            _this.loggers.requests.write(new Date().toISOString() + ", " + event.status + ", " + event.url + ", " + event.time + "ms, " + ((_a = event.user) !== null && _a !== void 0 ? _a : '') + ", " + Utils.serializeError((_b = event.error) !== null && _b !== void 0 ? _b : event.message));
            var status = event.status;
            if (event.error) {
                status = (_d = (_c = event.error) === null || _c === void 0 ? void 0 : _c.statusCode) !== null && _d !== void 0 ? _d : 500;
            }
            if (status <= 404 || _this.slack == null) {
                return;
            }
            if (_this.add(event) === false) {
                return;
            }
            if (((_f = (_e = _this.opts) === null || _e === void 0 ? void 0 : _e.filterForSlack) === null || _f === void 0 ? void 0 : _f.call(_e, event)) === false) {
                return;
            }
            _this.slack.send((_h = (_g = event.error) === null || _g === void 0 ? void 0 : _g.stack) !== null && _h !== void 0 ? _h : event.message);
        });
        this.events.on('HandlerSuccess', function (event, req, res) {
            var _a;
            _this.loggers.requests.write(new Date().toISOString() + ", " + event.status + ", " + event.url + ", " + event.time + "ms, " + ((_a = event.user) !== null && _a !== void 0 ? _a : ''));
        });
    };
    Watcher.prototype.writeError = function (error) {
        var _a, _b;
        if (this.add(error) === false) {
            return;
        }
        if ((_a = this.opts) === null || _a === void 0 ? void 0 : _a.filterForSlack({ error: error })) {
            (_b = this.slack) === null || _b === void 0 ? void 0 : _b.send(event.toString());
        }
        this.loggers.errors.write(new Date().toISOString() + ", " + Utils.serializeError(error));
    };
