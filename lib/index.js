...
class LoggerFile {
    ...
    static create(key, opts) {
        let logger = new LoggerFile(Object.assign({}, opts));
        return logger;
    }
    static prepair(opts) {
...
class ChannelReader {
    ...
    getData(query) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rows = yield alot_1.default(readers)
                ...
                .toArrayAsync();
            if (fields == null) {
                fields = (_c = rows === null || rows === void 0 ? void 0 : rows[0]) === null || _c === void 0 ? void 0 : _c.map((x, idx) => {
                    return {
                        idx: idx,
                        name: '',
                        type: 'string'
...
class MonitWorker {
    ...
    restoreChannelsAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let directoryExists = yield atma_io_1.Directory.existsAsync(this.opts.directory);
...
(function (Monit) {
    ...
    function createChannelReader(name, opts) {
        let channel = LoggerFile_1.LoggerFile.create(name, Object.assign({ directory: null }, opts));
        return new ChannelReader_1.ChannelReader(channel);
    }
    Monit.createChannelReader = createChannelReader;
    function flush() {
