...
var Watcher = /** @class */ (function () {
    ...
    Watcher.prototype.watch = function () {
        ...
        this.events.on('HandlerError', function (event, req, res) {
            ...
            if (((_c = _this.opts) === null || _c === void 0 ? void 0 : _c.filterForSlack(event)) === false) {
                return;
            }
            (_d = _this.slack) === null || _d === void 0 ? void 0 : _d.send((_f = (_e = event.error) === null || _e === void 0 ? void 0 : _e.stack) !== null && _f !== void 0 ? _f : event.message);
        });
