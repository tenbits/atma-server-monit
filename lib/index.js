...
var Watcher = /** @class */ (function () {
    ...
    Watcher.prototype.watch = function () {
        ...
        this.events.on('HandlerError', function (event, req, res) {
            var _a, _b, _c;
            _this.loggers.requests.write(new Date().toISOString() + ", " + event.status + ", " + event.url + ", " + event.time + "ms, " + ((_a = event.user) !== null && _a !== void 0 ? _a : '') + ", " + event.message);
            if (event.status <= 404) {
                return;
            }
            ...
            if (((_b = _this.opts) === null || _b === void 0 ? void 0 : _b.filterForSlack(event)) === false) {
                return;
            }
            (_c = _this.slack) === null || _c === void 0 ? void 0 : _c.send(event.message);
        });
