...
class Monit {
    ...
    watch(events) {
        ...
        events.on('HandlerError', (event, req, res) => {
            ...
            if (((_f = (_e = this.opts) === null || _e === void 0 ? void 0 : _e.filterForSlack) === null || _f === void 0 ? void 0 : _f.call(_e, event)) === false) {
                return;
            }
            this.slack.send((_h = (_g = event.error) === null || _g === void 0 ? void 0 : _g.stack) !== null && _h !== void 0 ? _h : event.message);
        });
...
exports.Monit = Monit;
//# sourceMappingURL=fs.js.map
//# sourceMappingURL=Monit.ts.map;

	function isObject(x) {
		return x != null && typeof x === 'object' && x.constructor === Object;
	}
	if (isObject(_src_Monit) && isObject(module.exports)) {
		Object.assign(_src_Monit, module.exports);
		return;
	}
	_src_Monit = module.exports;
}());
// end:source ./ModuleSimplified.js
...
const Monit_1 = _src_Monit;
var MonitFactory;
(function (MonitFactory) {
    let monit;
    function start(app, opts) {
        monit = new Monit_1.Monit(app.lifecycle, opts);
