...
var LoggerFile = /** @class */ (function () {
    ...
    LoggerFile.prototype.nextFile = function () {
        if (this._file != null)
            this._file.flush();
        var d = new Date();
        var filename = d.getTime() + "_" + this.switch_++ + "_" + Formatter.format(d, 'dd-MM_hh') + ".txt";
...
(function (Monit) {
    ...
    Monit.start = start;
    function flush() {
        watcher === null || watcher === void 0 ? void 0 : watcher.logger.flush();
    }
    Monit.flush = flush;
...
var Watcher = /** @class */ (function () {
    function Watcher(events, opts) {
        ...
        this.logger = new LoggerFile_1.LoggerFile();
        this.logger.init({
    ...
    Watcher.prototype.watch = function () {
        ...
        this.events.on('AppStart', function (event) {
            ...
            _this.logger.write(event.message);
        });
